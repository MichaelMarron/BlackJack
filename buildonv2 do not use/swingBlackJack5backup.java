...
public class swingBlackJack5backup implements ActionListener
{
	 ...
	 public void dealInitialCards()
	 {
	   ...
	   //ConsoleOutput.append("\nResults after Deal:\n..................\n");
		...
		for (int c=0; c<players.length; c++)
		{
			...
			{
				PlayerState[c] = PlayerState[c] + "Player " +(c+1) + " has a PERFECT hand of " + playVal + "\n";
				GameState = GameState + "Player " + (c+1) + " has a PERFECT hand of " + playVal + "\n";
				player_choice[c] = "s";
				finalValues[c] = playVal;
			}
			else
			{
				PlayerState[c] = PlayerState[c] + "Player " +(c+1) + " has a hand of value: " + playVal + "\n";
				GameState = GameState + "Player " + (c+1) + " hand has a value of " + playVal + "\n";
			}
		}
		...
		{
			GameState = GameState + "The Dealer has a perfect hand!\n...GAME OVER...\n";
			PlayerState[0] = PlayerCardsState[0] = "The Dealer has a perfect hand!\n...GAME OVER...\n";
		...
		{
			GameState = GameState + "The Dealer's hand has a value of " + dealVal + "\n";
			PlayerState[0] = PlayerCardsState[0] = "The Dealer's hand has a value of "+ dealVal +"\n";
		}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (e.getSource()==blackjackStick)
		{
			...
			if (startLogic == true)
			{
				...
				GameState = GameState + "Player " + (playerCount+1) + "Has stuck ending thier turn\n";
