		...
		public void run() {
			...
			while(keepGoing) {
				...
				case ChatMessage.RETRIEVE:
					...
					broadcast("Game State: " + x + " End of game State");
				...
				case ChatMessage.ARRAY:
					//broadcast(username + ": " + message + "THIS GUY TOTALLY POSTED AN ARRAY");
					//for(int i = 0; i > 2; i++) {
					System.out.println("Attempting to print array");
					int numbervalue = testarray[1];
					String stringvalue =Integer.toString(numbervalue);

					System.out.println( array[1] );
					broadcast(stringvalue);
					//}
					break;
				*/
